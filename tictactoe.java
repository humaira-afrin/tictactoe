...
public class tictactoe {
    ...
    private static boolean isGameFinished (char [][]board){
        if (hasContastantWon(board, 'X')){
            printBoard(board);
            System.out.println("player wins");
            return true;
        }
        if (hasContastantWon(board, 'O')){
            printBoard(board);
    ...
    private static boolean hasContastantWon (char [][]board, char symbol){
        if ((board [0][0]==symbol&& board [0][1]==symbol && board [0][2]==symbol)||
            ...
            (board [0][2]==symbol&& board [1][0]==symbol && board [2][2]==symbol)||
